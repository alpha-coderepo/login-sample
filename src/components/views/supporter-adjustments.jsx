...
const SupporterAdjustments = () =>
	<div>
     <main>
        <div className="container-fluid">
            <h1 className="mt-4">Supporter Adjustments</h1>
            <ol className="breadcrumb mb-4">
                <li className="breadcrumb-item active">Supporter Adjustments</li>
            </ol>
...
export default SupporterAdjustments;
