...
const RelatedPartyAdjustments = () =>
	<div>
     <main>
        <div className="container-fluid">
            <h1 className="mt-4">Related Party Adjustments</h1>
            <ol className="breadcrumb mb-4">
                <li className="breadcrumb-item active">Related Party Adjustments</li>
            </ol>
...
export default RelatedPartyAdjustments;
